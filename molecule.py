...
def xrotation(xform, deg):
    return _molecule.xrotation(xform, deg)
xrotation = _molecule.xrotation

def yrotation(xform, deg):
    return _molecule.yrotation(xform, deg)
yrotation = _molecule.yrotation

def zrotation(xform, deg):
    return _molecule.zrotation(xform, deg)
...
def compare_atom(a, b):
    return _molecule.compare_atom(a, b)
compare_atom = _molecule.compare_atom
